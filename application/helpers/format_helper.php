...
function formatType(array $post, $environment, $view)
{
	foreach ($post as &$postItem)
	{
		...
		{
			case "image":
				$postItem["content"] = $view == "all" ? "<img src=\"".$environment."/images/posts/".$postItem["content"]."\" width=\"280\" />" : "<img src=\"".$environment."/images/posts/".$postItem["content"]."\" width=\"".$postItem["width"]."\" height=\"".$postItem["height"]."\" />";
				break;
			case "youtube":
